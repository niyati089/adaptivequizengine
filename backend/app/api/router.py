...
from app.api.routes import socratic, explanation, review, socratic_advanced
...
api_router.include_router(socratic_advanced.router, prefix="/socratic-advanced", tags=["socratic-advanced"])
